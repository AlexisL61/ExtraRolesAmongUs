...
namespace ExtraRolesMod
{
    public class DeadPlayer
    {
        ...
        public bool CanBeDetect {get; set; }
        public double BodyPositionX {get; set; }
        public double BodyPositionY {get; set; }
    }
    ...
    public static class ExtraRoles
    {
        ...
        {
            public static PlayerControl Detector;
            public static bool showDetector = true;
            public static void ClearSettings()
            {
                Detector = null;
            }
